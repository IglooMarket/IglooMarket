...
**!!다음 sql문 insert하고 시작해주세요!**
**INSERT INTO users (email, pwd, phone_number, name) VALUES ('user22@example.com', 'password22', '019-1234-0021', '김삿갓')**
**(ex. 014-9876-1222 → 010-9876-1222)**
**참고사항: 019, 014 등 여러개가 존재합니다 한문장으로 바꿔보세요.**
